...
# Metro Train Predictions App - Improved Installation Script
# Enhanced error handling and port conflict detection
...
main() {
    ...
    # Start services sequentially with validation
    log "Starting services..."
    docker compose up -d
    
    # Wait for and validate each service
